					...
					<div class="row">
        					...
        					elseif(isset($_GET['success']))
        					{
        						echo '<div class="alert alert-success">
        						  <strong>Blogs Added Successfully!</strong>
        						</div>';
        					}
        					?>
							<div class="card">
									...
									<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										...
										<tbody>
											...
											<tr class="show">
                        						...
                        						<td>
                        						<a href="blog-create.php?id=<?php echo $row['id'];?>"  class="btn btn-outline-success btn-sm"><i class="fas fa-edit"></i></a>
