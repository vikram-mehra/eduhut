										...
										<tbody>
											...
											?>
													<tr class="show">
														...
														<td>
															<a href="course-create.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-success btn-sm"><i class="fas fa-edit"></i></a>
	...
	<script type="text/javascript">
		$(function() {
			$(".delete").click(function() {
				...
				var info = 'delete_course_id=' + del_id;
				if (confirm("Are you sure you want to delete this?")) {
					$.ajax({
						type: "POST",
						url: "coursesController.php",
						data: info,
						success: function() {}
					});
