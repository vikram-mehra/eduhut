				...
				<div class="container-fluid">
					<div class="page-title-box">
						<div class="row align-items-center">
							<div class="col-sm-6">
								<h4 class="page-title">User Master View</h4>
							</div>
						</div>
					</div>
					<!-- end row -->
							...
							<div class="card">
								<div class="card-body">
									<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										...
										<tbody>
										    <?php					
											$sql="select * from pdu_user ORDER BY id DESC";
											...
											<tr class="show">
                        						...
                        						<td><?php echo $row['certificate_valid_date'];     ?></td>
                        						<td>
                        						<a href="userCreate.php?student_id=<?php echo $row['id'];?>"  class="btn btn-outline-success btn-sm"><i class="fas fa-user-edit"></i></a>
