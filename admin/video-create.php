...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
	$sql = "select * from tbl_videos as videos 
			where videos.id=$id";
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-body">
									...
									<form class="repeater" enctype="multipart/form-data" name="form1" method="post" action="videoController.php">
										<div>
											<div class="row">
												...
												<div class="col-lg-2 align-self-center">
													...
													if (isset($_GET['id'])) {
													?>
														<input data-repeater-delete type="submit" class="btn btn-primary btn-block" name="video_update" value="Update">
													<?php
													} else {
													?>
														<input data-repeater-delete type="submit" class="btn btn-primary btn-block" name="video_add" value="Add">
													<?php
													}
													?>
												</div>
