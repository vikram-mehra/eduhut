				...
				<div class="container-fluid">
					<div class="page-title-box">
						<div class="row align-items-center">
							...
							<div class="col-sm-12">
								<h4 class="page-title">Videos List</h4>
						...
						<div class="col-12">
							...
							if (isset($_GET['msg'])) {
								echo '<div class="alert alert-warning">
        						  <strong>Blogs Already Exists!</strong>
        						</div>';
								...
								<div class="card-body">
									<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										...
										<tbody>
											<?php
											$i = 0;
											$sql = "select videos.*,cat.name from tbl_videos as videos LEFT JOIN courses as cat
											ON videos.course=cat.id
	...
	<script type="text/javascript">
		$(function() {
			$(".delete").click(function() {
				...
				var info = 'delete_video_id=' + del_id;
