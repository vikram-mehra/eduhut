...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Project Management Professional (PMP)® certification is the most distinguished professional qualification for project managers offered by Project Management Institute (PMI)®. ">
...
display: none;
  ...
  <div class="row">
    ...
    <section class="popular-courses-area" style="background-image: url(img/core-img/texture.png);padding-top:20px; alt="edhut";>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
    ...
    <section class="blog-area" style="padding-top:40px;">
        <div class="container">
            ...
            <a href="online-PMP-Training.php" class="blog-headline">
                    ...
                    <p class="text-justify"><img style="float: left; margin: 0px 15px 15px 0px;" src="img/bg-img/PMP1S.png" width="100" />Online PMP Training</b> The certification is relevant for professionals who are seeking 
    ...
    padding-bottom: 10px;">
                ...
                <div class="col-12 col-md-6">
                   ...
                   <a href="online-ACP-Training.php" class="blog-headline">
                    ...
                    <p class="text-justify"><img style="float: left; margin: 0px 15px 15px 0px;" src="img/bg-img/ACP.png" width="100" /><b>Online ACP Training</b> Our PMI® Agile Certified Practitioner training program is aligned to the PMI® guidelines
    ...
    padding-bottom: 10px;">
                ...
                <div class="col-12 col-md-6">
                   <a href="#online-RMP-Training.php" class="blog-headline">
                    ...
                    <a href="#"p class="text-justify"><img style="float: left; margin: 0px 15px 15px 0px;" src="img/renew-certification.png" alt="RMPS-PMP" width="100" />
                    Renew your PMI Certifications
...
(function () {
  ...
  let birthday = "December 25, 2021 00:00:00",
